...
void detail::gather_root(void* data, std::size_t cnt, const Datatype&,
                         std::size_t rootRank) {};
void detail::gather(void* data, std::size_t cnt, const Datatype&,
                    std::size_t rootRank) {};
void detail::gatherv_root(void* data, const std::size_t* cnts, const Datatype&,
                          std::size_t rootRank) {};
void detail::gatherv(void* data, std::size_t cnt, const Datatype&,
                     std::size_t rootRank) {};
void detail::scatter_root(void* data, std::size_t cnt, const Datatype&,
                          std::size_t rootRank) {};
void detail::scatter(void* data, std::size_t cnt, const Datatype&,
                     std::size_t rootRank) {};
void detail::scatterv_root(void* data, const std::size_t* cnts, const Datatype&,
                           std::size_t rootRank) {};
void detail::scatterv(void* data, std::size_t cnt, const Datatype&,
                      std::size_t rootRank) {};
...
std::optional<std::size_t> detail::recv_server(void*, std::size_t, const Datatype&,
                                               Tag) {
  return std::nullopt;
}
