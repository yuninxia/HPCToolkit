...
template <>
struct DataTraits<fmt_metadb_fHdr_t>
    : ConstSizeDataTraits<fmt_metadb_fHdr_t, FMT_METADB_SZ_FHdr, 8> {
...
template <>
struct DataTraits<fmt_metadb_generalSHdr_t>
    : ConstSizeDataTraits<fmt_metadb_generalSHdr_t, FMT_METADB_SZ_GeneralSHdr, 8> {
  ...
  void update_parent(parent_type& parent, std::uint_fast64_t offset,
...
template <>
struct DataTraits<fmt_metadb_idNamesSHdr_t>
    : ConstSizeDataTraits<fmt_metadb_idNamesSHdr_t, FMT_METADB_SZ_IdNamesSHdr, 8> {
...
template <>
struct DataTraits<fmt_metadb_metricsSHdr_t>
    : ConstSizeDataTraits<fmt_metadb_metricsSHdr_t, FMT_METADB_SZ_MetricsSHdr, 8> {
...
template <>
struct DataTraits<fmt_metadb_metricDesc_t>
    : ConstSizeDataTraits<fmt_metadb_metricDesc_t, FMT_METADB_SZ_MetricDesc, 8> {
...
template <>
struct DataTraits<fmt_metadb_propScopeInst_t>
    : ConstSizeDataTraits<fmt_metadb_propScopeInst_t, FMT_METADB_SZ_PropScopeInst, 8> {
...
template <>
struct DataTraits<fmt_metadb_summaryStat_t>
    : ConstSizeDataTraits<fmt_metadb_summaryStat_t, FMT_METADB_SZ_SummaryStat, 8> {
...
template <>
struct DataTraits<fmt_metadb_propScope_t>
    : ConstSizeDataTraits<fmt_metadb_propScope_t, FMT_METADB_SZ_PropScope, 8> {
...
template <>
struct DataTraits<fmt_metadb_modulesSHdr_t>
    : ConstSizeDataTraits<fmt_metadb_modulesSHdr_t, FMT_METADB_SZ_ModulesSHdr, 8> {
...
template <>
struct DataTraits<fmt_metadb_moduleSpec_t>
    : ConstSizeDataTraits<fmt_metadb_moduleSpec_t, FMT_METADB_SZ_ModuleSpec, 8> {
...
template <>
struct DataTraits<fmt_metadb_filesSHdr_t>
    : ConstSizeDataTraits<fmt_metadb_filesSHdr_t, FMT_METADB_SZ_FilesSHdr, 8> {
...
template <>
struct DataTraits<fmt_metadb_fileSpec_t>
    : ConstSizeDataTraits<fmt_metadb_fileSpec_t, FMT_METADB_SZ_FileSpec, 8> {
...
template <>
struct DataTraits<fmt_metadb_functionsSHdr_t>
    : ConstSizeDataTraits<fmt_metadb_functionsSHdr_t, FMT_METADB_SZ_FunctionsSHdr, 8> {
...
template <>
struct DataTraits<fmt_metadb_functionSpec_t>
    : ConstSizeDataTraits<fmt_metadb_functionSpec_t, FMT_METADB_SZ_FunctionSpec, 8> {
...
template <>
struct DataTraits<fmt_metadb_contextsSHdr_t>
    : ConstSizeDataTraits<fmt_metadb_contextsSHdr_t, FMT_METADB_SZ_ContextsSHdr, 8> {
...
template <>
struct DataTraits<fmt_metadb_entryPoint_t>
    : ConstSizeDataTraits<fmt_metadb_entryPoint_t, FMT_METADB_SZ_EntryPoint, 8> {
...
template <> struct DataTraits<fmt_metadb_context_t> {
