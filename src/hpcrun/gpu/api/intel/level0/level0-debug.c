...
#if ZE_MAJOR_VERSION(ZE_API_VERSION_CURRENT_M) >= 1 && ZE_MINOR_VERSION(ZE_API_VERSION_CURRENT_M) >= 7
...
#if ZE_MAJOR_VERSION(ZE_API_VERSION_CURRENT_M) >= 1 && ZE_MINOR_VERSION(ZE_API_VERSION_CURRENT_M) >= 4
    R2S(ZE_RESULT_WARNING_ACTION_REQUIRED)                // v1.4
#endif
#if ZE_MAJOR_VERSION(ZE_API_VERSION_CURRENT_M) >= 1 && ZE_MINOR_VERSION(ZE_API_VERSION_CURRENT_M) >= 10
    R2S(ZE_RESULT_ERROR_INVALID_KERNEL_HANDLE)            // v1.10
#endif
#if ZE_MAJOR_VERSION(ZE_API_VERSION_CURRENT_M) >= 1 && ZE_MINOR_VERSION(ZE_API_VERSION_CURRENT_M) >= 13
