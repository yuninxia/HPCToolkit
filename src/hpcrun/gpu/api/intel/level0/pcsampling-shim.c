...
#define HPCRUN_PCSAMPLING_CXX_SO "libhpcrun_pcsampling_cxx.so"
...
static pcsampling_hpcrun_api_t pcsampling_hpcrun_api = {
    ...
    .kernel_size_lookup = level0_kernel_size_map_lookup,  // Kernel size lookup from libhpcrun
...
init(void)
{
    ...
    Lmid_t scope = getenv("HPCRUN_PCSAMPLING_VISIBLE") ? LM_ID_BASE : LM_ID_NEWLM;
