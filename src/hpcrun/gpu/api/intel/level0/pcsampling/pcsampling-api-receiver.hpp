...
ze_result_t callZeDeviceGetProperties(ze_device_handle_t hDevice,
                                     ...
                                     const struct hpcrun_foil_appdispatch_level0* dispatch);
ze_result_t callZeDeviceGetRootDevice(ze_device_handle_t hDevice, ze_device_handle_t* phRootDevice,
                                     const struct hpcrun_foil_appdispatch_level0* dispatch);
...
ze_result_t callZetMetricGroupGetProperties(zet_metric_group_handle_t hMetricGroup,
                                           ...
                                           const struct hpcrun_foil_appdispatch_level0* dispatch);
ze_result_t callZetContextActivateMetricGroups(ze_context_handle_t hContext,
...
ze_result_t callZetMetricStreamerClose(zet_metric_streamer_handle_t hMetricStreamer,
                                      const struct hpcrun_foil_appdispatch_level0* dispatch);
ze_result_t callZetMetricStreamerReadData(zet_metric_streamer_handle_t hMetricStreamer,
