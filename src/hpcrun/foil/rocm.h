...
#define rocm_tracing_operation_t \
...
#define ROCPROFILER_PC_SAMPLING_RECORD_CODE_OBJECT_LOAD_MARKER ROCPROFILER_PC_SAMPLING_RECORD_CODE_OBJECT_LOAD_MARKER
#define ROCPROFILER_PC_SAMPLING_RECORD_CODE_OBJECT_UNLOAD_MARKER ROCPROFILER_PC_SAMPLING_RECORD_CODE_OBJECT_UNLOAD_MARKER
...
#define  ROCPROFILER_BUFFER_TRACING_MEMORY_ALLOCATION ROCPROFILER_BUFFER_TRACING_MEMORY_ALLOCATION
#else
