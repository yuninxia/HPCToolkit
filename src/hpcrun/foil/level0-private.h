...
struct hpcrun_foil_appdispatch_level0 {
  ...
  ze_result_t (*zeDriverGetExtensionFunctionAddress)(ze_driver_handle_t, const char*,
                                                     void**);
  ...
  ze_result_t (*zeEventQueryKernelTimestampsExt)(ze_event_handle_t, ze_device_handle_t, uint32_t *,
  ...
  ze_result_t (*zeContextCreate)(ze_driver_handle_t, const ze_context_desc_t*,
                                 ze_context_handle_t*);
  ze_result_t (*zeDeviceGetSubDevices)(ze_device_handle_t, uint32_t*,
                                       ze_device_handle_t*);
  ...
  ze_result_t (*zeCommandListGetDeviceHandle)(ze_command_list_handle_t,
                                              ze_device_handle_t*);
  ze_result_t (*zetMetricGet)(zet_metric_group_handle_t, uint32_t*,
                              zet_metric_handle_t*);
  ze_result_t (*zetMetricGetProperties)(zet_metric_handle_t, zet_metric_properties_t*);
  ze_result_t (*zetContextActivateMetricGroups)(zet_context_handle_t,
