...
static void init_dispatch() {
  dispatch_val = (struct hpcrun_foil_appdispatch_level0){
      ...
      .zeDeviceGetRootDevice = foil_dlsym("zeDeviceGetRootDevice"),
      .zeDeviceGetSubDevices = foil_dlsym("zeDeviceGetSubDevices"),
      .zeContextCreate = foil_dlsym("zeContextCreate"),
      ...
      .zeCommandListGetDeviceHandle = foil_dlsym("zeCommandListGetDeviceHandle"),
      ...
      .zeEventHostSignal = foil_dlsym("zeEventHostSignal"),
      .zeEventHostSynchronize = foil_dlsym("zeEventHostSynchronize"),
      .zeModuleCreate = foil_dlsym("zeModuleCreate"),
      .zeModuleDestroy = foil_dlsym("zeModuleDestroy"),
      .zeModuleGetKernelNames = foil_dlsym("zeModuleGetKernelNames"),
      .zeModuleGetFunctionPointer = foil_dlsym("zeModuleGetFunctionPointer"),
      .zeKernelCreate = foil_dlsym("zeKernelCreate"),
      .zeKernelDestroy = foil_dlsym("zeKernelDestroy"),
      .zeKernelGetProperties = foil_dlsym("zeKernelGetProperties"),
      ...
      .zetContextActivateMetricGroups = foil_dlsym("zetContextActivateMetricGroups"),
      .zetMetricGet = foil_dlsym("zetMetricGet"),
      .zetMetricGetProperties = foil_dlsym("zetMetricGetProperties"),
      .zetMetricGroupCalculateMultipleMetricValuesExp =
          foil_dlsym("zetMetricGroupCalculateMultipleMetricValuesExp"),
      .zetMetricGroupGet = foil_dlsym("zetMetricGroupGet"),
      .zetMetricGroupGetProperties = foil_dlsym("zetMetricGroupGetProperties"),
      .zetMetricStreamerOpen = foil_dlsym("zetMetricStreamerOpen"),
      .zetMetricStreamerClose = foil_dlsym("zetMetricStreamerClose"),
      .zetMetricStreamerReadData = foil_dlsym("zetMetricStreamerReadData"),
      .zelTracerSetPrologues = foil_dlsym("zelTracerSetPrologues"),
      .zelTracerSetEpilogues = foil_dlsym("zelTracerSetEpilogues"),
      .zelTracerSetEnabled = foil_dlsym("zelTracerSetEnabled"),
      .zelTracerCreate = foil_dlsym("zelTracerCreate"),
      .zelTracerDestroy = foil_dlsym("zelTracerDestroy"),
  };
}
