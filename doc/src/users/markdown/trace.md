...
Trace view ([Tallent et al. 2011](https://doi.acm.org/10.1145/1995896.1995908)) is a time-centric user interface for interactive examination of a sample-based time series (hereafter referred to as a trace) view of a program execution.
...
(fig:hpctraceviewer-callpath)=

| Trace dimensions |
| :--------------: |
|![Trace View](images/hpctraceviewer-callpath.png)|
...
(fig:hpctraceviewer-legend)=

| Trace view with legends |
| :---------------------: |
|![A screenshot of Trace view](images/traceview-legend.png)|
...
(fig:hpctraceviewer-stat)=

| Trace view with the Summary View and Statistics View |
| :--------------------------------------------------: |
| ![Summary View and Statistics View](images/traceview-stat.png) |
...
- **Home** ![image](icons/fullscreen-rectangular-symbolic.svg) : Resetting the view configuration into the original view, i.e., viewing traces for all times and processes.

- **Horizontal zoom in ![image](icons/zoom-in-horizontal.svg) / out** ![image](icons/size-horizontally-symbolic.svg) : Zooming in/out the time dimension of the traces.

- **Vertical zoom in ![image](icons/zoom-in-vertical.svg) / out ![image](icons/size-vertically-symbolic.svg)** : Zooming in/out the process dimension of the traces.

- **Navigation buttons** ![image](icons/arrow4-left-symbolic.svg), ![image](icons/arrow4-right-symbolic.svg), ![image](icons/arrow4-up-symbolic.svg), ![image](icons/arrow4-down-symbolic.svg) : Navigating the trace view to the left, right, up and bottom, respectively. It is also possible to navigate with the arrow keys in the keyboard. Since Main View does not support scroll bars, the only way to navigate is through navigation buttons (or arrow keys).

- **Undo** ![image](icons/history-undo-symbolic.svg) : Canceling the action of zoom or navigation and returning back to the previous view configuration.

- **Redo** ![image](icons/history-redo-symbolic.svg) : Redoing of previously undo change of view configuration.

- **Save** ![image](icons/bookmark-save.svg) / **Open ![image](icons/bookmark-outline-symbolic.svg) a view configuration** : Saving/loading a saved view configuration.
...
Similar to [Profile View's thread selection](sec:thread-level-table), one can narrow the list by specifying the name of the execution context on the filter part of the window. 
