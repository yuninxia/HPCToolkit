...
desktop systems to the world's largest GPU-accelerated supercomputers.
HPCToolkit can measure a program's work, resource
consumption, and inefficiency on both CPUs and GPUs.
HPCToolkit correlates such metrics with the
